...
\DeclareUnicodeCharacter{221E}{\ensuremath{\ge}}
...
\maketitle
    ...
    \begin{figure}[H]
        \centering
        \label{fig:embassy1}
        \includegraphics[width=346px]{img/{5.www.chile.embassy.gov.au}.png}
        \caption{traceroute a http://www.chile.embassy.gov.au - Parte I}
    \end{figure}

    \begin{figure}[H]
        \centering
        \label{fig:embassy2}
        \includegraphics[width=346px]{img/{6.www.chile.embassy.gov.au}.png}
        \caption{traceroute a http://www.chile.embassy.gov.au - Parte II}
    \end{figure}
